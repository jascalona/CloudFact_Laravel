                                                        ...
                                                        <div class="tab-pane active w-100" id="fill-tabpanel-0"
                                                            ...
                                                            <div class="cont" id="show_global">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="number" step="0.01" class="form"
                                                                        placeholder="0.00" aria-label="Username"
                                                                        aria-describedby="basic-addon1" value="{{ $alquiler->P_CLICK_BN_BS }}">
                                                                </div>
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="number" step="0.01" class="form"
                                                                        placeholder="0.00" aria-label="Username"
                                                                        aria-describedby="basic-addon1" value="{{ $alquiler->P_CLICK_COLOR_BS }}">
                                                                </div>
                                            ...
                                            <div class="alquiler">
                                                ...
                                                <div class="input-group mb-4">
                                                    ...
                                                    <input type="text" class="form-" name="rif"
                                                        ...
                                                        aria-describedby="basic-addon1" readonly value="{{ $alquiler->rif }}">
                                                </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form" placeholder="Por ejemplo: 056JE22K"
                                                        aria-label="Username" aria-describedby="basic-addon1" value="{{ $alquiler->n_contract }}">
                                                </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" class="form" placeholder="Por ejemplo: 12"
                                                        aria-label="Username" aria-describedby="basic-addon1" value="{{ $alquiler->d_contract }}">
                                                </div>
